            ...
            do
            {
                try
                {
                    ...
                    else if (opcao == 6)
                    {
                        ...
                        while (minhaPilha.Tamanho() > 0)
                        {
                            System.out.println("Nome: " + minhaPilha.RetornaTopo().nome 
                                    + "Salário: " + minhaPilha.RetornaTopo().salario);
                    ...
                    else if (opcao == 7)
                    {
                        ...
                        System.out.println("Removendo a base:\n" + "Nome: " + minhaPilha.RetornaTopo().nome +
                                "Salário: " + minhaPilha.RetornaTopo().salario);
